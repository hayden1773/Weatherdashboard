...
$("#geo").click(function () {
    ...
    var geometric = "https://api.openweathermap.org/geo/1.0/direct?q=" + userInput + "&appid=d67baf8d305d039eb72cb7c450af0a11";
    fetch(geometric)
        ...
        .then(function (data) {
            ...
            fetch(latLong)
                ...
                .then(function (data) {
                    ...
                    var iconUrl1 = "https://openweathermap.org/img/wn/" + data.daily[0].weather[0].icon + ".png"
                    console.log(iconUrl1)
                    iconOne.attr("src", iconUrl1)

                    day2.text(data.daily[1].temp.day)
                    var iconUrl2 = "https://openweathermap.org/img/wn/" + data.daily[1].weather[0].icon + ".png"
                    console.log(iconUrl2)
                    iconTwo.attr("src", iconUrl2)

                    day3.text(data.daily[2].temp.day)
                    var iconUrl3 = "https://openweathermap.org/img/wn/" + data.daily[2].weather[0].icon + ".png"
                    console.log(iconUrl3)
                    iconThree.attr("src", iconUrl3)

                    day4.text(data.daily[3].temp.day)
                    var iconUrl4 = "https://openweathermap.org/img/wn/" + data.daily[3].weather[0].icon + ".png"
                    console.log(iconUrl4)
                    iconFour.attr("src", iconUrl4)

                    day5.text(data.daily[4].temp.day)
                    var iconUrl5 = "https://openweathermap.org/img/wn/" + data.daily[4].weather[0].icon + ".png"
